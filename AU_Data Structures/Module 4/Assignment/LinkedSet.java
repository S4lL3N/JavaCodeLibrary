...
public class LinkedSet<T extends Comparable<T>> implements Set<T> {
    ...
    public boolean add(T element) {
        ...
        while (p != null) {
            if (element.compareTo(p.element) < 0) {
                ...
                return false; // if they're equal return false since we don't allow dupes
        }
    ...
    public boolean contains(T element) {
        for (T this_element : this) {
            if (element.compareTo(this_element) == 0)
                return true;
        }
        return false;
    }
    ...
    public boolean equals(LinkedSet<T> s) {
        ...
        while (this_it.hasNext() && s_it.hasNext()) {
            if (this_it.next().compareTo(s_it.next()) != 0)
                return false;
        }
    ...
    public Set<T> union(Set<T> s){
        ...
        if (this.isEmpty())
            return s;
        Set<T> rtnSet = new LinkedSet<T>();

        for (T element : this) rtnSet.add(element); // O(N^2)
        for (T element : s)    rtnSet.add(element); // O(N^2)
    ...
    public Set<T> intersection(Set<T> s) {
        ...
        for (T element : this) {
            if (s.contains(element)) rtnSet.add(element);
        }
    ...
    public Set<T> intersection(LinkedSet<T> s) {
        ...
        if (this_current.compareTo(s_current) == 0) rtnSet.add(s_current);
    ...
    public Set<T> complement(LinkedSet<T> s) {
        ...
        while (this_it.hasNext()) rtnSet.add(this_it.next());

        // Add the last element in this
        if (this_element.compareTo(s_element) != 0) rtnSet.add(this_element);
